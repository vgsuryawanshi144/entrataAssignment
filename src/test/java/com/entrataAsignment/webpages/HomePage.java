...
//	private WebElement howsItWorkBtn;
	...
	@FindBy(css = "body > section.main-section.hp > div.hp-c-product-suite-section > div > div.position-relative > div.lottie-animation._1index > svg > g")
	private WebElement dynamicContent;

	@FindBy(css = "body > section.main-section.hp > div.hp-c-video-section > div > a > img")
	...
	public Boolean verifyDynamicContentIsPresent() {
		waitForElementDisplayed(dynamicContent);
		return true;

	}

	public boolean verifyFooterContentIsDisplayed() {
		waitForElementDisplayed(footerContent);
		return true;
	}
}
